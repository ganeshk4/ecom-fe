			...
			<div className="bdy">
					...
					<section>
						<div className={styles.footerSection}>
							<Grid container spacing={2}>
								<Grid item xs={3}>
									<Typography variant="h5" component="h5">Shop Category</Typography>
								</Grid>
								<Grid item xs={3}>
									<Typography variant="h5" component="h5">Quick Links</Typography>
								</Grid>
								<Grid item xs={3}>
									<Typography variant="h5" component="h5">Contact Us</Typography>
								</Grid>
							</Grid>
						</div>
					</section>
